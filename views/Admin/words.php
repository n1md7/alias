...
<section class="my-5">
	...
	<div class="row d-flex justify-content-sm-center">
		<div class="col col-sm-3 text-center py-2 my-1 clearfix">
			<input type="text" maxlength="16" placeholder="Word" class="js-word-name form-control float-right">
		</div>
		<div class="col col-sm-auto text-center py-2 my-1 clearfix pl-0">
					...
					success: function(response){
						...
						setTimeout(function(){
							$('.js-words-jar').prepend(`
								<button class="animated fadeIn js-words-delete btn btn-sm btn-primary p-1 m-1" data-id="${response.id}">${$('.js-word-name').val()} <i class="fa fa-close"></i></button>
								`);
